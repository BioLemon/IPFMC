...
def ipfmc_discretize(datasets, pathwayinfo, k=5, fusetime=6, proportion=0.6, snfk=15, seed=10, mirtarinfo=1,
                     mirna=False):
    """
    ...
    """
    def calgeneral(dataset, pathways, k,fusetime,proportion,seed):
        BP_data = pathways
        Omic_data = dataset
    ...
    for i in range(Dataset_Len - 1):
        ...
        represent, pathways = calgeneral(Omic_data, pathwayinfo,k,fusetime,proportion,seed)
